Pycord (Uploaded as pycord on pypi because using 'import discord' was very frustrating as it often had conflicts with the original discord.py and I'm too stupid to use venvs.)
======
...
.. code:: sh
    ...
    # Linux/macOS
    python3 -m pip install -U "pycord[voice]"

    # Windows
    py -3 -m pip install -U pycord[voice]
...
.. code:: sh
    ...
    # Linux/macOS
    python3 -m pip install -U "pycord[speed]"
    # Windows
    py -3 -m pip install -U pycord[speed]
...
.. code:: sh
    ...
    $ git clone https://github.com/SGtOriginal/pycord
    $ cd pycord
...
.. code:: sh
    ...
    # Linux/macOS
    python3 -m pip install git+https://github.com/SGtOriginal/pycord
    # Windows
    py -3 -m pip install git+https://github.com/SGtOriginal/pycord
